...
{
  printf("Opcao Apresentar Alunos e Medias dos Alunos selecionada\n");
  for(int i = 0; i < total_alunos; i++)
  {
...
int main()
{
  ...
  total_alunos = ler_ficheiro_alunos_bin(nomes, ids_aluno);
  do
  {
      ...
      printf("4. Gravar Dados dos Alunos em Binario\n");
      printf("0. Sair\n");
      ...
      switch(opcao)
      {
       ...
       case 4: grava_ficheiros_bin(nomes, ids_aluno, total_alunos); break;
